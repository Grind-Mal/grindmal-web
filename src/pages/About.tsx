...
import { GitBranch, GitMerge, GitPullRequest, Code, Users, Target, Zap, Shield, MessageCircle, Send } from "lucide-react";

const principles = [
  {
    icon: Code,
    title: "Real Code, Real Impact",
    description: "No toy projects. Every challenge is a real tool that ships to production. Your PRs matter.",
  },
  {
    icon: Target,
    title: "Weekly Cadence",
    description: "One repo. One week. Focused sprints that build habits and ship features fast.",
  },
  {
    icon: Zap,
    title: "Zero Fluff",
    description: "No gamification theater. No fake badges. Just code, reviews, and merges.",
  },
  {
    icon: Shield,
    title: "Quality First",
    description: "Every PR goes through real code review. Learn from feedback. Ship better code.",
  },
];
...
const steps = [
  {
    ...
    step: "01",
    title: "Pick an Issue",
    description: "Browse open issues labeled 'good first issue' or 'help wanted'. Find something that interests you.",
  },
  {
    icon: GitPullRequest,
    step: "02",
    title: "Submit a PR",
    description: "Fork the repo, write your code, and open a pull request. Follow the contribution guidelines.",
  },
  {
    icon: GitMerge,
    step: "03",
    title: "Get Reviewed & Merge",
    description: "Maintainers review your code. Address feedback, iterate, and get your code merged.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="container py-16 md:py-24">
          <div className="max-w-3xl">
            <h1 className="font-mono text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">
              <span className="text-gradient">GrindMal</span> is where developers build real tools, together.
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Weekly open-source challenges. Real repositories. Meaningful contributions. 
              No tutorials, no hand-holding — just code that ships. Join the grind.
            </p>
          </div>
        </section>
        ...
        {/* Principles */}
        <section className="container py-16 md:py-24">
          <h2 className="font-mono text-2xl font-bold text-foreground mb-8">Our Principles</h2>
            ...
            {principles.map((principle) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-mono text-lg font-semibold text-foreground">{principle.title}</h3>
                </div>
        ...
        <section className="container py-16 md:py-24">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h2 className="font-mono text-2xl font-bold text-foreground mb-4">Join the Community</h2>
        ...
        <section className="border-t border-border">
          <div className="container py-16 md:py-24">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <cite className="text-primary font-mono">— The Grind Manifesto</cite>
            </div>
          </div>
        </section>
      </main>
